...
import GroupDetail from '../../../src/pages/group/GroupDetail';
...
const createPermissionMock = (overrides?: Partial<ReturnType<typeof usePermission>>) => ({
  isGroupAdmin: false,
  isOrgAdmin: false,
  isSystemAdmin: false,
  isViewer: false,
  ...
  isRoleAtLeast: vi.fn().mockReturnValue(false),
  currentRole: 'member',
...
describe('GroupDetail Authorization', () => {
  ...
  it('KHÔNG hiển thị Tab Cài đặt cho Member bình thường', async () => {
    vi.mocked(usePermission).mockReturnValue(createPermissionMock() as any);
