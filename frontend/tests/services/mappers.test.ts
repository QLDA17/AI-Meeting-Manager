...
import { normalizeDashboardStats, normalizeMeetingDetail, normalizeUser } from '../../src/services/mappers';
...
describe('mappers', () => {
  ...
  it('normalizes meeting detail flattened fields', () => {
    ...
    expect(detail.preferredSummaryLanguage).toBe('en');
    expect(detail.meetingDefaultSummaryLanguage).toBe('vi');
    expect(detail.availableSummaryLanguages).toEqual(['vi', 'en']);
