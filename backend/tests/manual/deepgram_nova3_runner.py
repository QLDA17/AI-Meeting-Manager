...
Usage:
    cd backend
    python tests/manual/deepgram_nova3_runner.py <audio_file>
...
def main():
    ...
    if args.audio_file:
        ...
        print("  python tests/manual/deepgram_nova3_runner.py path/to/audio.mp3")
        print("\nTo compare Nova 3 vs Nova 2:")
        print("  python tests/manual/deepgram_nova3_runner.py path/to/audio.mp3 --compare")
